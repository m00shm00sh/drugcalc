package com.moshy.drugcalc.testutil
 ...
 *
 */
internal class CheckArg<R, ParamsContainer> private constructor (
    ...
    fun withPostThrowHandler(block: () -> Unit): CheckArg<Unit, ParamsContainer> {
        ...
        return CheckArg(args, expectedException, { block() }, exceptionMessageMatcher, asserterMessage)
    }
    ...
    companion object {
        ...
        inline fun <reified Th: Throwable, ParamsContainer> throws(
            ...
            CheckArg<Any?, ParamsContainer>(args, Th::class, { /* rv */ }, { assertContains(matchPat, it, message) }, message)
        ...
        inline fun <reified Th: Throwable, ParamsContainer> throws(
            ...
            if (matchSubstr.isNotEmpty())
                CheckArg<Any?, ParamsContainer>(args, Th::class, { /* rv */ }, { assertContains(matchSubstr, it, message) }, message)
            else
                CheckArg(args, Th::class, { /* rv */ }, { /* ex.message */ }, message)
        ...
        fun <R, ParamsContainer> nothrow(
            ...
            CheckArg<R, ParamsContainer>(args, null, { matcher(it) }, { /* ex.message */ }, message)
